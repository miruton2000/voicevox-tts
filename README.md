...
DISCORD_OWNER_ID=your-user-id # 必須 : TTSを行いたいユーザーのID
DISCORD_APPLICATION_ID=bot-application-id # 必須 : botのアプリケーションID
VOICEVOX_ENGINE_PORT=port-number # 任意 : VOICEVOX Engineのポート番号 (default: 50021)
```
